package com.gigigo.themoviesapp.detail.data.model
...
data class ApiMovieDetail(
    ...
    @SerializedName("genres") val genres: List<ApiGenre>? = listOf(),
    ...
    @SerializedName("production_companies") val productionCompanies: List<ApiCompany>? = listOf(),
    @SerializedName("production_countries") val productionCountries: List<ApiCountry>? = listOf(),
    @SerializedName("release_date") val releaseDate: String? = "",
    @SerializedName("revenue") val revenue: Int? = 0,
    @SerializedName("runtime") val runtime: Int? = 0,
    @SerializedName("spoken_languages") val spokenLanguages: List<ApiLanguage>? = listOf(),
